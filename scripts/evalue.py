...
# -*- coding: utf-8 -*-
# Código listo para pegar en tu app (compatible con Streamlit o script puro)

# -*- coding: utf-8 -*-
# Código listo para pegar (Streamlit o script). Mantiene evaluar_imagen_completa.
...
# name_modelo = "92 [[54  0]  [ 5  6]].pth"
name_modelo = "best_model_export.pth"
n_metros = 3
